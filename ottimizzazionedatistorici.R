...
rendimentoMassimo<-0.11 # il rendimento obiettivo è la media, in seguito da ottimizSenzaBench si userà il secondo elemento
...
#matrice covarianza
covarianze<-cov(rendimentiannualizzati)
...
mediastorica<-matrix(,ncol=14,nrow=41)
